...
4. I tidied up column names further to make sure that each data set contains year, age, going_out, country, gender columns and the columns with names of the same sweets have the same names across all three data sets and binded all three sets together.
...
The most popular candy bar in US and Canada was 'any_full_sized_candy_bar'.

The most popular candy bar in the UK were 'any_full_sized_candy_bar'. 
